 ...
 * @author sanket
 */
public class Sign_up_tm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(930, 499));
        ...
        */
        ...
        else
        {
            try
            {
                ...
                String query="INSERT INTO login (Email,Name,Phone_no,Roll_no,Password) VALUES (?,?,?,?,?)";
                PreparedStatement q=con.prepareStatement(query);
                q.setString(1, Email);
                q.setString(2, name.getText());
                q.setString(3, phone.getText());
                q.setString(4, roll.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sign_up_tm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
